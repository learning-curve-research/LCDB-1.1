...
# input_path = '/lcdb11/experiments_265_CatBoost_nofs/'     # jobs 1-18
input_path = '/lcdb11/experiments_265_TabNet_nofs/'     # jobs 1-13


# database file name
output_filename = "LCDB11_ER_265_tabnet_nofs_new.hdf5"
            ...
            with open(str(file_path), 'r') as file:
                for line in file:
                    try:
                        ...
                        # === only release: feature_scaling=False and realistic=True  ===
                        if json_obj.get('feature_scaling') is not False:
                            continue
                        if json_obj.get('realistic') is not True:
                            continue
                        # ============================================================
